...
export const gameBonusDesigns: Record<GameBonusType, GameBonusDesign> = {
    ...
    [GameBonusType.Weapon_Increase_2_FireRate_5sec]: new GameBonusDesign(GameBonusType.Weapon_Increase_2_FireRate_5sec, "assets/themes/default/bonus/weapon_increase_2_fire_rate_5sec.svg", 20, 20),
