...
export const intermediateWaves_4: WaveConfig[] = [
    {
    ...
    {
        delay: 3, // Seconde vague après 20 secondes
        invaders: [
            { type: InvaderType.Light, count: 5, row: 1 },
            { type: InvaderType.Light, count: 5, row: 2 },
        ],
    ...
    {
        delay: 1, // Seconde vague après 20 secondes
        invaders: [
            { type: InvaderType.Fast_Kamikaze, count: 5, row: 1 },
            { type: InvaderType.Fast_Kamikaze, count: 5, row: 2 },
        ],
...
export const maxIntermediateWave4: number = intermediateWaves_4.length;