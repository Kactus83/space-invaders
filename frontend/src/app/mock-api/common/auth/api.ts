...
export class AuthMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        // -----------------------------------------------------------------------------------------------------
        // @ Sign in with MetaMask - POST
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/auth/sign-in/metamask', 1500)
            .reply(({request}) =>
            {
                // Simulez ici la vérification de la signature MetaMask.
                // Pour les besoins de la démo, nous supposons que la signature est toujours valide.
