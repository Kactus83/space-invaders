...
export class GamePlayScene {
    ...
    sync(gameState: any): void {
        // Synchronisez l'état du jeu ici avec gameState
        console.log('Synchronizing game state:', gameState);
        // Exemple : this.player.position = gameState.player.position;
    }
