...
export const gameBonusDesigns: Record<GameBonusType, GameBonusDesign> = {
    ...
    [GameBonusType.Weapon_Double_Firerate_10sec]: new GameBonusDesign(GameBonusType.Weapon_Double_Firerate_10sec, "assets/themes/default/bonus/weapon_double_fire_rate_10sec.svg", 20, 20),
    [GameBonusType.Weapon_Double_Firerate_20sec]: new GameBonusDesign(GameBonusType.Weapon_Double_Firerate_20sec, "assets/themes/default/bonus/weapon_double_fire_rate_20sec.svg", 20, 20),
